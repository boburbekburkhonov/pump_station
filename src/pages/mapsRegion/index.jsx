...
import {
  ...
  findMyLocationsPolygonByRegionId,
} from "../../redux/actions/stationsActions";
import Loading from "../../components/loading";

function RegionMapsPage() {
  const dispatch = useDispatch();
  const { stationsMap, stationsPolygonByRegionId, stationsLoading } = useSelector(
  ...
  const fetchAllData = useCallback(() => {
    ...
    dispatch(findMyLocationsPolygonByRegionId(lang, regionId, token));
  ...
  if (!stationsPolygonByRegionId?.pointsPolygon) {
    return (
      <section className="map_container">
  ...
  return (
    ...
    >
      <MapWithPolygon
        data={stationsPolygonByRegionId}
