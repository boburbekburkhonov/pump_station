...
function Districts() {
  ...
  const { districtsForDistrict } = useSelector((state) => state.district);
  ...
  const fetchAllData = useCallback(() => {
    ...
    dispatch(getAllDistrictData(lang, token, pageData.page, pageData.perPage));
  ...
  const deleteDistrict = async () => {
    try {
      ...
      const res = await postDataApi(`districts/delete?lang=${lang}`, data, token);
  ...
  const columns = [
    {
      title: t("district.item10"),
      dataIndex: "name",
      key: "name",
      align: "center",
    },
    {
      title: t("district.item3"),
  ...
  return (
    ...
    >
        ...
        >
          <div className="modal_region-form-row">
            <div className="modal_region-form-group">
              <label style={{color: colors.text}}>{t("district.item3")} (uz)</label>
            ...
            <div className="modal_region-form-group">
              <label style={{color: colors.text}}>{t("district.item3")} (en)</label>
              <div className="modal_region-input-icon">
                <span>EN</span>
                <input
                  name="name_en"
                  type="text"
                  placeholder="Kitab region"
                  required
                />
              </div>
            </div>
          ...
          <div className="modal_region-form-row">
            <div className="modal_region-form-group">
              <label style={{color: colors.text}}>{t("district.item3")} (ru)</label>
              <div className="modal_region-input-icon">
                <span>🇷🇺</span>
                <input
                  name="name_ru"
                  type="text"
                  placeholder="Китабский район"
                  required
                />
              </div>
            </div>
            <div className="modal_region-form-group">
              <label style={{color: colors.text}}>{t("district.item11")}</label>
              <Select
          ...
          <div className="modal_region-form-row">
            <div className="modal_region-form-group">
              <label style={{color: colors.text}}>{t("district.item4")}</label>
              <div className="modal_region-input-icon">
                <span>🧭</span>
                <input
                  name="latitude"
            ...
            <div className="modal_region-form-group">
              <label style={{color: colors.text}}>{t("district.item5")}</label>
              <div className="modal_region-input-icon">
                <span>🧭</span>
                <input
                  name="longitude"
        ...
        <div className="modal_delete-content">
          <div className="modal_delete-header">
            <img
              ...
              alt="warning"
            />
            <h2>{t("district.item6")}</h2>
          </div>
          <div className="modal_delete-body">
            <p>
              <strong>
                {oneRegionForDelete.name} {t("district.item7")}
              </strong>
            </p>
            <p className="modal_delete-warning">⚠ {t("district.item8")}</p>
          </div>
      ...
      <Table
        ...
        columns={columns}
        dataSource={districtsForDistrict.data}
        pagination={{
          current: pageData.page,
          pageSize: pageData.perPage,
          total: districtsForDistrict.totalDocuments,
