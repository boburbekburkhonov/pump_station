...
function DataPage() {
  ...
  const { stationsMap, stationsLoading, stationsLastData, stationsId } = useSelector(
            ...
            <Card key={index} type='inner' className='data_paga_card_element'>
              <div className='data_page_card_header'>
                ...
                <img
                  ...
                  src={
                    filterStationsId(item?.id) ? CheckBookmark : UnCheckBookmark
                  }
                  alt='Images'
              ...
              <div className='data_page_aggrigate_container'>
                {item.aggregate?.map((itemAg, indexAg) => (
                  <div className='data_page_aggrigate_card_item' key={indexAg}>
                    <h3>{itemAg.name}</h3>
                    ...
                    <div className='data_page_aggrigate_item_child_row'>
                      ...
                      <Link
                        to={`/agrigate/infos/${itemAg?.pumpLastData?.aggregateId}`}
