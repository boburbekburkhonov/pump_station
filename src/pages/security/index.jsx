  ...
  return (
    ...
    >
      <div className="settings_right_privacy_container">
        ...
        <h2 style={{ color: colors.loginHeadingColor, marginBottom: '10px' }}>
        ...
        <h2
          className="heading_privacy_content"
          style={{ color: colors.loginHeadingColor, marginBottom: '10px' }}
        >
          {t("settingNavbar.privacy.item11")}
        </h2>
        <p style={{ color: colors.text }}>
          {t("settingNavbar.privacy.item12")}
        </p>
        <ul>
        ...
        <p style={{ color: colors.text }}>
          {t("settingNavbar.privacy.item18")}
        </p>
        <ul>
        ...
        <h2 style={{ color: colors.loginHeadingColor, margin: '10px 0' }}>
          {t("settingNavbar.privacy.item23")}
        </h2>
        <p style={{ color: colors.text }}>
          {t("settingNavbar.privacy.item24")}
        </p>
        <ul>
        ...
        <h2
          className="heading_privacy_content"
          style={{ color: colors.loginHeadingColor, marginTop: '10px' }}
        >
        ...
        <div
          ...
          style={{
            borderLeft: `5px solid ${colors.buttonColor}`,
            background: "#d4d4d4",
            color: "#000",
          }}
        >
          ...
          <p>
            ...
            {t("settingNavbar.privacy.item35")}
          </p>
        </div>
      </div>
    </main>
